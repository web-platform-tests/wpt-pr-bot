...
var NO_COLAB = "None of the OWNERs of this pull request are repo collaborators. Please reach out on irc at [irc.w3.org#testing](irc://irc.w3.org:6667/#testing) ([web client](http://irc.w3.org/?channels=testing)) to get someone to merge this or get added as a collaborator. Thank you!";
    
var NO_OWNERS = "There are no OWNERs for this pull request. Please reach out on irc at [irc.w3.org#testing](irc://irc.w3.org:6667/#testing) ([web client](http://irc.w3.org/?channels=testing)) to get help with this. Thank you!";
...
module.exports = function(number, metadata) {
    if (metadata.reviewers.length) { // If there reviewers we abord early. They know best.
        return promise();
    } else {
