...
module.exports = function(number, metadata) {
    ...
    if (metadata.authorIsCollaborator) {
        ...
        body = "These tests will be available on [w3c-test.org](" + BASE_TEST_URL + number + "/) as soon as they are [approved](https://github.com/w3c/web-platform-tests/blob/master/README.md#publication) by a repository collaborator.";
    }
